...
class Admission extends Component {    
    ...
    handleFormValidation() {    
        ...
        if (confirm_password === '' || confirm_password !== password) {    
            formIsValid = false;    
            formErrors["confirm_passwordErr"] = "Confirm_password dosen't match";    
        }    
                ...
                <div>    
                    <form onSubmit={this.handleSubmit}>    
                        ...
                        <div>    
                            ...
                            {emailIdErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{emailIdErr}</div>    
                            }    
                        ...
                        <div>    
                            ...
                            {dobErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{dobErr}</div>    
                            }    
                        </div>    
                        <div>    
                            ...
                            {genderErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{genderErr}</div>    
                            }    
                        </div>    
                        <div>    
                            ...
                            {phoneNumberErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{phoneNumberErr}</div>    
                            }    
                        </div>    
                        <div>    
                            ...
                            {passwordErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{passwordErr}</div>    
                            }    
                        </div>    
                        <div>    
                        <label htmlFor="confirm_password">Confirm Password  </label>    
                            ...
                            {confirm_passwordErr &&    
                                <div style={{ color: "white", paddingBottom: 10 }}>{confirm_passwordErr}</div>    
                            }    
                        </div>    
